...
export default function MortalHome() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden selection:bg-primary/30 selection:text-primary dark">
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between gap-6">
            ...
            <div className="flex-shrink-0 flex items-center gap-3">
              <img src="/__mockup/images/mortal-logo.png" alt="Mortal" className="w-10 h-10 md:w-12 md:h-12 object-contain" />
            ...
            <div className="flex items-center gap-3">
              ...
              <Button onClick={() => window.open(whatsappLink, '_blank')} className="hidden sm:flex bg-primary hover:bg-primary/90 text-primary-foreground font-bold rounded-full px-6 hover-glow transition-all">
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-[100] bg-background/95 backdrop-blur-xl lg:hidden flex flex-col">
          <div className="flex justify-between items-center p-4 border-b border-white/10">
            <div className="flex items-center gap-3">
              <img src="/__mockup/images/mortal-logo.png" alt="Mortal" className="w-8 h-8" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="flex flex-col gap-6 text-center lg:text-right order-2 lg:order-1">
              ...
              <h1 className="text-5xl lg:text-7xl font-black text-white leading-[1.1] tracking-tight">
                ارفع مستوى <br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-l from-primary to-blue-500 text-glow">اللعب الخاص بك</span>
              </h1>
              <p className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0 font-medium leading-relaxed">
                أحدث القطع، أقوى التجميعات، وأفضل اللابتوبات. مورتال يوفر لك كل ما تحتاجه لتجربة أداء لا مثيل لها مع ضمان حقيقي ودعم فني متواصل.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mt-4 justify-center lg:justify-start">
                <Button size="lg" className="h-14 px-8 bg-primary hover:bg-primary/90 text-primary-foreground font-bold text-lg rounded-full hover-glow transition-all">
                  تسوق الآن
                </Button>
            ...
            <div className="order-1 lg:order-2 relative">
              <div className="relative rounded-2xl overflow-hidden border border-white/10 box-glow aspect-video lg:aspect-square group">
                <img 
                  src="/__mockup/images/mortal-hero.png" 
              ...
              {/* Floating Element */}
              <div className="absolute -bottom-6 -left-6 glass-effect p-4 rounded-xl border border-white/10 shadow-2xl hidden md:flex items-center gap-4 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
            ...
            {[
              {
                ...
                price: '$3,850',
                image: '/__mockup/images/mortal-hero.png',
                badge: 'جديد'
              },
              {
                ...
                price: '$2,100',
                image: '/__mockup/images/mortal-components.png',
                badge: 'الأكثر مبيعاً'
              },
              {
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 group h-80 md:h-[400px]">
              <img src="/__mockup/images/mortal-laptops.png" alt="Laptops" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-60" />
            ...
            <div className="grid grid-rows-2 gap-6 h-80 md:h-[400px]">
              ...
              <div className="relative rounded-3xl overflow-hidden border border-white/10 group">
                <img src="/__mockup/images/mortal-monitors.png" alt="Monitors" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-50" />
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-center items-start w-2/3">
                  ...
                  <Button variant="link" className="text-primary hover:text-primary/80 font-bold p-0">
                    اكتشف المزيد
                  </Button>
                </div>
              </div>
              ...
              {/* Accessories Promo */}
              <div className="relative rounded-3xl overflow-hidden border border-white/10 group">
                <img src="/__mockup/images/mortal-accessories.png" alt="Accessories" className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-50" />
                <div className="absolute inset-0 bg-gradient-to-r from-background/90 to-transparent"></div>
                <div className="absolute inset-0 p-6 flex flex-col justify-center items-start w-2/3">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center glass-effect p-8 md:p-16 rounded-3xl border-primary/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                <img src="/__mockup/images/mortal-logo.png" alt="Mortal" className="w-10 h-10" />
                <span className="font-black text-2xl tracking-tight text-white">MORTAL</span>
              </div>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                المتجر الأول في العراق المتخصص في بيع وتجميع أجهزة الكمبيوتر الإحترافية واللابتوبات بأسعار تنافسية وضمان حقيقي.
              </p>
              <div className="flex items-center gap-4 text-muted-foreground">
                <a href="#" className="hover:text-primary transition-colors"><div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center"><Phone className="w-4 h-4" /></div></a>
                <a href="#" className="hover:text-primary transition-colors"><div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center"><MessageCircle className="w-4 h-4" /></div></a>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-muted-foreground text-sm font-medium">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">سياسة الضمان</a></li>
